// Análise Estatística Básica em Lista Numérica
// Dada uma lista de números inteiros, calcule o desvio
// padrão amostral de forma simplificada. O processo envolve:
// 1) calcular a média; 
